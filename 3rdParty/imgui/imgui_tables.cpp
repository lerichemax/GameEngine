...
void ImGui::TableSetupColumn(const char* label, ImGuiTableColumnFlags flags, float init_width_or_weight, ImGuiID user_id)
{
    ...
    if (table->IsInitializing)
    {
        // RootInitialize width or weight
        ...
        // RootInitialize default visibility/sort state
...
//-------------------------------------------------------------------------
// [RootInitialize] 1: TableSettingsHandler_ReadXXXX()   Load and parse .ini file into TableSettings.
