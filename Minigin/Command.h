...
namespace dae
{
	...
	{
	public:
		Command(KeyActionState state) : m_KeyAction{ state }, m_LastKeyState{LastKeyState::up} {}
		...
		LastKeyState GetLastKeyState() const { return m_LastKeyState; }
		void SetLastKeyState(LastKeyState lks) { m_LastKeyState = lks; }

	protected:
		KeyActionState m_KeyAction;
		LastKeyState m_LastKeyState;
	};
