...
public:
	...
	virtual void Deserialize(void* pClass, JsonReader* const reader, SerializationMap& context) = 0;
...
public:
	...
	void Deserialize(void* pClass, JsonReader* const reader, SerializationMap& context) override;
