...
namespace ecs
{
	...
	template<ComponentDerived... Components>
	typename View<Components...>::ViewIterator& View<Components...>::ViewIterator::operator=(View<Components...>::ViewIterator const& other)
	{
	...
	template<ComponentDerived... Components>
	typename View<Components...>::ViewIterator& View<Components...>::ViewIterator::operator++()
	{
		m_Iterator++;
		Advance();
		return *this;
